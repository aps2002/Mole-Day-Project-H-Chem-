...
/**
 * Maze.fx created on 2017-10-20, 20:22:15 <br>
 * Maze.java created October 2017
 *
...
//  ];
    ...
    final StringBinding messageBinding = new StringBinding() {
            ...
            protected String computeValue() {
                if (gamePaused.get()) {
                    ...
                    return "HAPPY MOLE DAY, PRESS ANY KEY!";
                }
            }
        };
    ...
    final StringBinding lastGameResultBinding = new StringBinding() {
        ...
        protected String computeValue() {
            if (lastGameResult.get()) {
                ...
                return "Game over, sig figs error";
            }
        }
    };
    ...
    final Text textScore = new Text(MazeData.calcGridX(0),
            ...
            "MOLE'S SCORE: " + pacMan.score);
    textScore.textProperty().bind(pacMan.score.asString("MOLE'S SCORE: %1d  "));
